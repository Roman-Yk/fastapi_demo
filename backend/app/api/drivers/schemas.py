...
SortModel = create_sort_model(["id", "name", "phone"])


# Query parameters for driver collection
class CollectionDriverQueryParams(CollectionQueryParams):
    """
    Query parameters for driver collection.
...
# Response schema
class ResponseDriverSchema(ResponseBaseModel):
    id: uuid.UUID
    name: str
    phone: str 